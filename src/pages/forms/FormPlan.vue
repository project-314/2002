...
export default {
  ...
  methods: {
    async sendMessage(message) {
      console.log("อาชีพเป้าหมาย", this.plan_career_id.label);
      console.log("คุณสมบัติ/ทักษะ", this.qa_plan_career_id.label);

      message =
        "เงื่อนไข " +
        " อาชีพเป้าหมาย:" +
        this.plan_career_id.label +
        " คุณสมบัติ/ทักษะ:" +
        this.qa_plan_career_id.label +
        " คำสั่ง " +
